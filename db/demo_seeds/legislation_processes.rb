section "Creating DEMO collaborative legislation" do
  ...
  annotation = draft.annotations.create!(quote: "Wild pet animal: is that belonging to the native or foreign fauna, which has required a period of adaptation to the human environment and that is maintained by man, mainly in his home, by the pleasure and company, without being the object of any lucrative activity.",
                                         ranges: [{
                                                    start: "/ol[1]/li[3]/p[1]",
                                                    startOffset: 0,
                                                    end: "/ol[1]/li[3]/p[1]",
                                         ...
                                         text: "It would be interesting to introduce a definition of non-native species introduced into the country.",
                                         author_id: 4,
                                         range_start: "/ol[1]/li[3]/p[1]",
                                         range_start_offset: 0,
                                         range_end: "/ol[1]/li[3]/p[1]",
                                         range_end_offset: 265,
                                         context: "<span class=annotator-hl>Wild pet animal: is that belonging to the native or foreign fauna, which has required a period of adaptation to the human environment and that is maintained by man, mainly in his home, by the pleasure and company, without being the object of any lucrative activity.</span>",
                                         created_at: "04/08/2019",
                                         updated_at: "04/08/2019")

  annotation = draft.annotations.create!(quote: "Law 2/1991",
                                         ranges: [{
                                                    start: "/p[6]",
                                                    startOffset: 22,
                                                    end: "/p[6]",
                                         ...
                                         text: "Any reference to the Law 4/1997?",
                                         author_id: 5,
                                         range_start: "/p[6]",
                                         range_start_offset: 22,
                                         range_end: "/p[6]",
                                         range_end_offset: 33,
                                         context: "Domestic Animals, the <span class=annotator-hl>Law 2/1991</span>of Protection of the Fauna and Wild Flora of the Community, and other regulations that can be for him of application.",
                                         created_at: "05/08/2019",
                                         updated_at: "05/08/2019")

  annotation = draft.annotations.create!(quote: "visually impaired.",
                                         ranges: [{
                                                    start: "/ol[1]/li[8]/p[1]",
                                                    startOffset: 126,
                                                    end: "/ol[1]/li[8]/p[1]",
                                         ...
                                         text: "That should be prioritized as an accesibility human right.",
                                         author_id: 6,
                                         range_start: "/ol[1]/li[8]/p[1]",
                                         range_start_offset: 126,
                                         range_end: "/ol[1]/li[8]/p[1]",
                                         range_end_offset: 145,
                                         context: "Guide dog: is the one who is accredited as trained in national or foreign centers recognized, to accompany, drive and help the<span class=annotator-hl>visually impaired.</span>",
                                         created_at: "06/08/2019",
                                         updated_at: "06/08/2019")
